...
class NASimEnv(gym.Env):
    ...
    def update_actions(self):
        if self.flat_actions:
            ...
            self.action_space.actions = [action for action in self.action_space.actions if self.current_state.host_discovered(action.target)]
        else:
    ...
    def step(self, action):
        ...
        # if self.steps >= 1000:
        #     reward = reward - self.steps/100.0
